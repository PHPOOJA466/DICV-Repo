		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zclaimapproval-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zclaimapproval-display": {
								"semanticObject": "zclaimapproval",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zclaimapproval",
									"url": sap.ui.require.toUrl("zclaimapproval")
								}
							}
						}
					}
